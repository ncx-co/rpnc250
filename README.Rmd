...
### Cubic feet
We can summarize total merchantable volume up to 4" top very easily. First
we can join the plot-level basal area table to the tree table, then we can 
estimate height to 4" top for each stem, and finally we can estimate stem-level
volumes.
```{r cuft}
...
height to 9" for softwood trees, and 10" for hardwood trees.
